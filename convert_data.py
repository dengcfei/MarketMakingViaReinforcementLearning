...
#df_600519.to_csv(r'data/600519/{date_str}/price.csv', index=False)
    ...
    df_order = pd.read_csv(f'data/600519/{date_str}/Entrust.csv', header=None)
    ...
    df_trade = pd.read_csv(f'data/600519/{date_str}/Tick.csv', header=None)
