...
df = pd.read_csv(r'data/20230320/Snapshot.small.csv')
...
#df_600519.to_csv(r'data/600519/20230320/price.csv', index=False)


df_order = pd.read_csv(r'data/20230320/Entrust.small.csv')
...
df_order_600519.to_csv(r'data/600519/20230320/order.csv', index=False)


df_trade = pd.read_csv(r'data/20230320/Tick.small.csv')
...
df_trade_600519.to_csv(r'data/600519/20230320/trade.csv', index=False)
