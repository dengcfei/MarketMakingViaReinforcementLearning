...
date_str='20230322'
df = pd.read_csv(f'data/{date_str}/Snapshot.small.csv')
...
df_order = pd.read_csv(f'data/{date_str}/Entrust.small.csv')
...
df_trade = pd.read_csv(f'data/{date_str}/Tick.small.csv')
